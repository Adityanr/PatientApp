    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                calendar.set(Calendar.HOUR_OF_DAY,22);//setting time using edittext
                ...
                calendar2.set(Calendar.HOUR_OF_DAY,22);//setting time using edittext
                ...
                calendar3.set(Calendar.HOUR_OF_DAY,22);//setting time using edittext
                calendar3.set(Calendar.MINUTE,26);
